    ...
    public static function form(Form $form): Form
    {
        ...
        return $form
            ->schema([
              ...
              ->schema([
                ...
                Forms\Components\TextInput::make('instagram_handle')->label('Instagram Handle (optional)')->columnSpan('full'),
                Forms\Components\Textarea::make('res_description_en')->label('About Resturant')->required(),
                Forms\Components\TextInput::make('meat_poultry_source_en')->label('Meat & Poultary Sources')->columnSpan('full'),
            ]),
            ...
            ->schema([
                ...
                Forms\Components\TextInput::make('meat_poultry_source_ar')->label('Meat & Poultary Sources')->columnSpan('full'),
            ]),
        ...
        Forms\Components\Section::make('Location & Foods Trucks')->schema([
            ...
            Forms\Components\Repeater::make('locations') ->schema([
                Forms\Components\TextInput::make('location_name')->label('Location Name'),
                Forms\Components\TextInput::make('location_url')->label('Location Url'),
    ...
    Forms\Components\Fieldset::make('Delivery Options')->schema([
        ...
        Forms\Components\Section::make('Menus')->schema([
            Forms\Components\Repeater::make('menus')->label('')->schema([
                Forms\Components\TextInput::make('menu_name')->label('Menu Name'),
                Forms\Components\TextInput::make('menu_url')->label('Menu Url'),
        ...
        Forms\Components\Section::make('Photos')->schema([
            Forms\Components\Repeater::make('photo_Items')->label('')->schema([
                ...
                Forms\Components\TextInput::make('name_en')->label('caption\Item Name (English)'),
                Forms\Components\TextInput::make('name_ar')->label('caption\Item Name (Arabic)'),
                Forms\Components\TextInput::make('price')->label('Price (BHD)'),
        ...
        Forms\Components\Section::make('Shukris Favourites')->schema([
            Forms\Components\Repeater::make('fav_Items')->label('')->schema([
                Forms\Components\TextInput::make('name_en')->label('Item Name (English)'),
                Forms\Components\TextInput::make('name_en')->label('Item Name (Arabic)'),
                Forms\Components\FileUpload::make('images')->image(),
                Forms\Components\TextInput::make('price')->label('Price (BHD)'),
